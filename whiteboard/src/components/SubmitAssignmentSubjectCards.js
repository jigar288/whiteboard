...
class SubmitAssignmentSubjectCards extends React.Component {
    ...
    render() {
      ...
      const viewSubjectEvents = () => {
        this.props.history.push('/submit-assignments-by-subject', { subjectName : this.props.subjectName, courseColor: this.props.courseColor, subjectEvents: this.props.subjectEvents });
      };
...
export default withRouter(SubmitAssignmentSubjectCards);
