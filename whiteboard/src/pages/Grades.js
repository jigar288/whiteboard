...
import SocialScienceCalendarEvents from '../data/subject-events/SocialStudiesCalendarEvents'
...
class Grades extends React.Component {
  constructor(props){
    ...
    const socialStudies = new Course("Social Studies", "Andrew Johnson", "#f79914", '/social-studies-grades', 'https://i.imgur.com/SdMxPEq.jpg', "90", "#ffffff", SocialScienceCalendarEvents);
